...
sendData.meals.forEach((e,i) => {
      ...
      <h2 class=
      'text-center text-secondary mt-5'>Food Area: ${e.strArea}</h2>
       <h2 class=
      'text-center text-warning'>Food Name: ${e.strMeal}</h2>
      <div class="row">
             <div class="col-md-4">
...
<div class="modal fade" id="exampleModal${i}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      `
      heading.innerHTML=` <h2 class=
      'text-center text-danger'>Food Category: ${sendData.meals[0].strCategory}</h2>`
 ...
 document.querySelector('.notfound').innerHTML= "Meal Not Found 😢";
  ...
  let mealCategory = fetch(`www.themealdb.com/api/json/v1/1/categories.php`);
  mealCategory.then((getData)=>{
      return getData.json();
  }
  ).then((sendData)=>{
      console.log(sendData);
    ...
    data +=`
    <h2 class=
          'text-center text-secondary mt-5'>${e.strCategory}</h2>`
    })
  });